...
const AppointmentForm = () => {
    ...
    const onSubmit = (data, e) => {
        ...
        axios({
            ...
            .then(r => {
                handleServerResponse(true, "Sent. Response within 24 hours on average.", form);
            })
            .catch(r => {
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormGroup mb="20px">
                ...
                >
                    ...
                    <option value="General Information Request">General Inquiry</option>
                    <option value="Partner Relations">Partner Relations</option>
                    <option value="Careers">Careers</option>
                    <option value="Software Licencing">All Other Inquires</option>
                </Select>
